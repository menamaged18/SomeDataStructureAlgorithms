...
public:
    ...
    Node(int val)
        : key(val), left(NULL), right(NULL),height(1) {}
};
...
private:
    ...
    Node* rightRotate(Node *p) {
        //p is the main node 
        //pleft is the left node of p that will be rotated
    ...
    Node* leftRotate(Node *p) {
        /*
            ...
            we put PRLeft in the left of the node p because its is smaller than Pright and greater than p
        */   
        Node *pRight = p->right;
